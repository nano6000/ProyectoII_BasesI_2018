...
<body>
  ...
  $query="select * from nano.Huerta";
        ...
        while ($fila = oci_fetch_array($matriz, OCI_NUM+OCI_RETURN_NULLS)) {
            echo "<tr>";
            echo "<td> <h6>" . $fila[0] . "</h> </td>";
            echo "<td> <h6>" . $fila[1] . "</h> </td>";
            echo "<td> <h6>" . $fila[2] . "</h> </td>";
            echo "<td> <h6>" . $fila[3] . "</h> </td>";
            echo "<td> <h6>" . $fila[4] . "</h> </td>";
            echo "<td> <h6>" . $fila[5] . "</h> </td>";
            echo "<td> <h6>" . $fila[6] . "</h> </td>";

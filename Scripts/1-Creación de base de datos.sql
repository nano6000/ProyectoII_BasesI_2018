...
BEGIN
	RETURN EXISTS(SELECT tipoUsuario_idtipoUsuario 
                   FROM `Usuario` 
                   WHERE nombreUsuario = pUser AND CAST(AES_ENCRYPT(pPass, 'Progra2018')as CHAR(45)) = contrasena);
END$$
...
BEGIN
	RETURN EXISTS(SELECT tipoUsuario_idtipoUsuario 
                   ...
                   AND CAST(AES_ENCRYPT(pPass, 'Progra2018') AS CHAR(45)) = contrasena);
END$$
...
BEGIN
     ...
     INSERT INTO `usuario`(`nombreUsuario`, `contrasena`, `puntosActuales`, `puntosGastados`, `puntosTotales`, `tipoUsuario_idtipoUsuario`, `Persona_cedula`) VALUES (pUser,CAST(AES_ENCRYPT(pPass, 'Progra2018')AS CHAR(512)),0,0,0,pTipo,pCedula);
     END$$

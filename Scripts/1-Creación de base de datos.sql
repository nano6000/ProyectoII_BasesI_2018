...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Pais` (
  ...
  PRIMARY KEY (`idPais`))
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los paises.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Provincia` (
  ...
  CONSTRAINT `fk_Provincia_Pais1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar las provincias.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Canton` (
  ...
  CONSTRAINT `fk_Canton_Provincia1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tablas para almacernar los cantones';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Distrito` (
  ...
  CONSTRAINT `fk_Distrito_Canton1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los distritos.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Persona` (
  ...
  CONSTRAINT `fk_Persona_Pais1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar las persona y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`CorreoXPersona` (
  ...
  CONSTRAINT `fk_correosXpersona_Persona1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los correos electrónicos por persona y su información.';
...
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los tipos de usuarioy información.';
...
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los tipos de comercio y información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Comercio` (
  ...
  CONSTRAINT `fk_Comercio_TipoComercio1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los comercios y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Localizacion` (
  ...
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar la localización exacta de los centros de acopio.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`CentroAcopio` (
  ...
  CONSTRAINT `fk_CentroAcopio_Usuario1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los centros de acopio.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`TelefonoXPersona` (
  ...
  CONSTRAINT `fk_telefonosXpesona_Persona1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar los números de teléfono por persona y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`ProductoXUsuario` (
  ...
  CONSTRAINT `fk_Producto_has_Usuario_Usuario1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar las personas y su información.\n';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Puntos` (
  ...
  CONSTRAINT `fk_Puntos_EquivalenciaMaterial1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar la información de los puntos.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`topUsuarioXDia` (
  ...
  CONSTRAINT `fk_topUsuarioXDia_CentroAcopio1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacernar el usuario top por día.';
...
CREATE PROCEDURE `productosMasCanjeados`() 
    ...
    SQL SECURITY DEFINER 
BEGIN
    SELECT p.nombre, COUNT(pxu.Producto_idProducto), c.nombreComercio
        FROM producto p, productoxusuario pxu, comercio c
        WHERE p.idProducto = pxu.Producto_idProducto
...
CREATE PROCEDURE `totalProductos`() 
    ...
    SQL SECURITY DEFINER 
BEGIN
SELECT MONTH(pxu.fecCreacion), YEAR(pxu.fecCreacion), COUNT(pxu.Producto_idProducto) 
    FROM productoxusuario pxu
    GROUP BY YEAR(pxu.fecCreacion), MONTH(pxu.fecCreacion) 
    ORDER BY COUNT(pxu.Producto_idProducto) DESC;
END$$

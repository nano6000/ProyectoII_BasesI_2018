...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Pais` (
  ...
  PRIMARY KEY (`idPais`))
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los paises.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Provincia` (
  ...
  CONSTRAINT `fk_Provincia_Pais1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar las provincias.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Canton` (
  ...
  CONSTRAINT `fk_Canton_Provincia1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tablas para almacenar los cantones';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Distrito` (
  ...
  CONSTRAINT `fk_Distrito_Canton1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los distritos.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Persona` (
  ...
  CONSTRAINT `fk_Persona_Pais1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar las persona y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`CorreoXPersona` (
  ...
  CONSTRAINT `fk_correosXpersona_Persona1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los correos electrónicos por persona y su información.';
...
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los tipos de usuarioy información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Usuario` (
  ...
  CONSTRAINT `fk_Usuario_Persona1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los usuarios y su información.';
...
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los tipos de comercio y información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Comercio` (
  ...
  CONSTRAINT `fk_Comercio_TipoComercio1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los comercios y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Producto` (
  ...
  CONSTRAINT `fk_Producto_Comercio1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los productos y su información.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Localizacion` (
  ...
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar la localización exacta de los centros de acopio.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`CentroAcopio` (
  ...
  CONSTRAINT `fk_CentroAcopio_Usuario1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los centros de acopio.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`TelefonoXPersona` (
  ...
  CONSTRAINT `fk_telefonosXpesona_Persona1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los números de teléfono por persona y su información.';
...
ENGINE = InnoDB
COMMENT = 'Tabla de equivalencias para los materiales.';


-- -----------------------------------------------------
-- Table `BanderaAzul`.`Canjes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `BanderaAzul`.`Canjes` ;

CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Canjes` (
  `idCodigo` INT NOT NULL AUTO_INCREMENT,
  `cantidad` INT NOT NULL COMMENT 'la cantidad a comprar del producto',
  ...
  CONSTRAINT `fk_Producto_has_Usuario_Usuario1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los canjes de los usuarios.\n';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`Puntos` (
  ...
  INDEX `fk_Puntos_EquivalenciaMaterial1_idx` (`idTipoPuntos` ASC),
  ...
  CONSTRAINT `fk_Puntos_centroAcopio1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Puntos_EquivalenciaMaterial1`
    FOREIGN KEY (`idTipoPuntos`)
    REFERENCES `BanderaAzul`.`EquivalenciaMaterial` (`idPuntos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar la información de los puntos dados al usuario.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`cambioClave` (
  `idcambioClave` INT NOT NULL AUTO_INCREMENT COMMENT 'Identificador del cambio de clave',
  ...
  CONSTRAINT `fk_cambioClave_Usuario1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar los distintos cambios de clave.';
...
CREATE TABLE IF NOT EXISTS `BanderaAzul`.`topUsuarioXDia` (
  `idtop` INT NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la tabla top de usuarios',
  `peso` VARCHAR(45) NOT NULL COMMENT 'La cantidad de reciclaje que llevo',
  `Usuario_nombreUsuario` VARCHAR(45) NOT NULL COMMENT 'Llave foránea',
  `CentroAcopio_idcentroAcopio` INT NOT NULL COMMENT 'Llave foránea',
  `fecCreacion` DATETIME NULL COMMENT 'Campo de auditoría',
  `usuarioCreacion` VARCHAR(45) NULL COMMENT 'Campo de auditoría',
  ...
  CONSTRAINT `fk_topUsuarioXDia_CentroAcopio1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Tabla para almacenar el usuario top por día.';
...
DELIMITER $$
USE `BanderaAzul`$$
CREATE PROCEDURE `obtenerProducto` (IN `pCom` INT)
	NOT DETERMINISTIC
    READS SQL DATA
    SQL SECURITY DEFINER
BEGIN
...
BEGIN
	SET @puntos = pPeso*(SELECT em.puntos
                        ...
                        WHERE em.idPuntos = pIdTipo);
	INSERT INTO `Puntos`(idTipoPuntos, peso, puntos, Usuario_nombreUsuario, centroAcopio_idCentroAcopio)
    VALUES (pIdTipo, pPeso, @puntos, pUser, pIdCentro);
	UPDATE `Usuario`
        SET `Usuario`.`puntosActuales`  = `Usuario`.`puntosActuales` + @puntos,
			`Usuario`.`puntosTotales`  = `Usuario`.`puntosTotales` + @puntos
		WHERE `Usuario`.`nombreUsuario` = pUser;
END$$
...
-- -----------------------------------------------------
-- procedure obtenerListadoMateriales
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`obtenerListadoMateriales`;
...
-- -----------------------------------------------------
-- procedure top5Usuarios
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`top5Usuarios`;
...
-- -----------------------------------------------------
-- procedure usuariosCentro
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`usuariosCentro`;
...
-- -----------------------------------------------------
-- procedure productosMasCanjeados
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`productosMasCanjeados`;
...
BEGIN
    SELECT p.nombre, SUM(ca.cantidad), c.nombreComercio
        ...
        WHERE p.idProducto = ca.Producto_idProducto
            AND p.Comercio_idComercio = c.idComercio
        GROUP BY p.nombre, c.nombreComercio
...
-- -----------------------------------------------------
-- procedure puntosUsuarios
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`puntosUsuarios`;
...
-- -----------------------------------------------------
-- procedure top5UsuarioTotal
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`top5UsuarioTotal`;
...
-- -----------------------------------------------------
-- procedure totalProductos
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`totalProductos`;
...
USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`cambiarClave`;
...
USE `BanderaAzul`;
DROP function IF EXISTS `BanderaAzul`.`obtenerContrasena`;
...
-- -----------------------------------------------------
-- procedure verPersona
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`verPersona`;
...
-- -----------------------------------------------------
-- procedure cambiosClaveUltimoMes
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`cambiosClaveUltimoMes`;
...
CREATE PROCEDURE `cambiosClaveUltimoMes`()
    ...
    SQL SECURITY DEFINER
BEGIN
	SELECT cedula, nombre, apellido, CONCAT(MONTH(fecha), '-', YEAR(fecha))fecha FROM(SELECT DISTINCT p.cedula cedula, p.nombrePersona nombre, CONCAT(p.primerApellidoPersona,' ',p.segundoApellidoPersona) apellido, (SELECT ci.fecCreacion
                                       FROM cambioclave AS ci
                                       WHERE ci.Usuario_nombreUsuario = u.nombreUsuario
                                       ORDER BY ci.fecCreacion DESC
                                       LIMIT 1) fecha
	FROM persona p
		JOIN usuario u ON p.cedula = u.Persona_cedula
			JOIN cambioclave c ON u.nombreUsuario = (SELECT ci.Usuario_nombreUsuario
                                                     FROM cambioclave AS ci
                                                     WHERE ci.Usuario_nombreUsuario = u.nombreUsuario
                                                 	 ORDER BY ci.fecCreacion DESC
                                                     LIMIT 1)) a
	WHERE MONTH(a.fecha)<MONTH(NOW());
END$$
...
USE `BanderaAzul`;
DROP function IF EXISTS `BanderaAzul`.`obtenerCedula`;
...
USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`updateTelefono`;
...
-- -----------------------------------------------------
-- procedure updateCorreo
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`updateCorreo`;
...
USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`updatePersona`;
...
-- -----------------------------------------------------
-- procedure editarComercio
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`editarComercio`;
...
-- -----------------------------------------------------
-- procedure editarCentro
-- -----------------------------------------------------

USE `BanderaAzul`;
DROP procedure IF EXISTS `BanderaAzul`.`editarCentro`;
...
BEGIN
	UPDATE centroacopio
        SET centroacopio.nombreCentroAcopio = pNombre,
            centroacopio.contacto = pContacto,
            centroacopio.Distrito_idDistrito = pDistrito
        WHERE idCentroAcopio = pIdCentro;
END$$
...
-- -----------------------------------------------------
-- View `BanderaAzul`.`listadoProductosXComercios`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `BanderaAzul`.`listadoProductosXComercios` ;
USE `BanderaAzul`;
CREATE OR REPLACE VIEW listadoProductosXComercios (Nombre_del_comercio, Nombre_del_producto, Precio_del_producto)
  AS SELECT Comercio.nombreComercio, Producto.nombre, Producto.precio
    FROM  Comercio, Producto
    WHERE (comercio.idComercio = producto.idProducto);
...
USE `BanderaAzul`$$
DROP TRIGGER IF EXISTS `BanderaAzul`.`Canjes_BEFORE_INSERT` $$
USE `BanderaAzul`$$
CREATE DEFINER = CURRENT_USER TRIGGER `BanderaAzul`.`Canjes_BEFORE_INSERT` BEFORE INSERT ON `Canjes` FOR EACH ROW
	SET NEW.fecCreacion = NOW(),
		NEW.usuarioCreacion = CURRENT_USER();$$


USE `BanderaAzul`$$
DROP TRIGGER IF EXISTS `BanderaAzul`.`Canjes_BEFORE_UPDATE` $$
USE `BanderaAzul`$$
CREATE DEFINER = CURRENT_USER TRIGGER `BanderaAzul`.`Canjes_BEFORE_UPDATE` BEFORE UPDATE ON `Canjes` FOR EACH ROW
	SET NEW.fecUltimaModificacion = NOW(),
		NEW.usuarioUltimaModificacion = CURRENT_USER();$$
